...
const features = [
  {
    ...
    description: "Only clean, pure ingredients sourced from trusted organic farms.",
  },
  {
    icon: "✋",
    title: "Handmade with Love",
    description: "Every batch shaped and packed by caring hands with attention to detail.",
  },
  {
    icon: "💪",
    title: "Designed for Wellness",
    description: "Energy, focus, balance, and tradition combined in every bite.",
  },
]
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <p className="text-stone-700 text-pretty">{feature.description}</p>
            </motion.div>
          ))}
        </div>
      </div>
