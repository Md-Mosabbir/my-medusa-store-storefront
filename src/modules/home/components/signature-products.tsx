  ...
  const products: Product[] = [
    {
      ...
      title: "Nokshi Pitha",
      description:
        "Traditional Bengali sweet made with rice flour and date molasses",
      ...
      tags: ["Family treats", "Festival celebrations", "Tea-time snack"],
    },
    {
      id: "brain-bars",
      title: "Brain Food Bars",
      description:
        "Soft brownie-style energy bars packed with nuts, seeds, and superfoods",
      ...
      ingredients: [
        ...
        { name: "Mixed nuts", fixed: false },
        { name: "Superfood seeds", fixed: false },
        { name: "Fresh coconut", fixed: false },
      ],
      tags: ["Post-gym recovery", "Study focus", "Energy boost"],
    },
    {
      id: "dubai-dates",
      title: "Dubai Chocolate Dates",
      description:
        "Luxury dessert bites with premium dates and dark chocolate coating",
      ...
      tags: ["Dessert after meals", "Pregnant women", "Study concentration"],
    },
  ]
